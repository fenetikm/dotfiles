...
"Toggle between done and in todo
"gary vimrc: https://github.com/garybernhardt/dotfiles/blob/master/.vimrc
...
function! ShiftTodoDone()
  let todoHeader = search('^#\+ Todo', 'nw')
  let doneHeader = search('^#\+ Done', 'nw')
  let currentPos = line('.')
  ...
  "#Done
  "-
  "Should we handle if done is above todo?
...
" Plug 'jkramer/vim-checkbox' "Checkbox management
...
Plug 'rhysd/clever-f.vim' "clever fFtT Plug 'chaoren/vim-wordmotion' "Expand the definition of what a word is
