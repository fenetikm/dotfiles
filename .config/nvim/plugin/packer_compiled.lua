...
_G.packer_plugins = {
  ...
  ["nvim-coverage"] = {
    ...
    loaded = true,
    path = "/Users/michael/.local/share/nvim/site/pack/packer/start/nvim-coverage",
  ...
  ["vim-fugitive"] = {
    commands = { "Git", "G", "Gstatus", "Gdiff", "Glog", "Gblame", "Gvdiff", "Gread", "Gmerge", "Gvdiffsplit", "Gdiffsplit" },
    loaded = false,
    needs_bufread = true,
    only_cond = false,
