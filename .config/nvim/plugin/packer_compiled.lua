...
vim.cmd [[au FileType php ++once lua require("packer.load")({'vim-php-manual', 'vim-php-namespace', 'vim-textobj-function', 'phpfolding.vim', 'splitjoin.vim', 'PHP-Indenting-for-VIm', 'vim-php'}, { ft = "php" }, _G.packer_plugins)]]
