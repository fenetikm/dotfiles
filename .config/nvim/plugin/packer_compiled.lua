...
vim.cmd [[au FileType php ++once lua require("packer.load")({'phpfolding.vim', 'splitjoin.vim', 'vim-php', 'vim-textobj-function', 'vim-php-manual', 'PHP-Indenting-for-VIm', 'vim-php-namespace'}, { ft = "php" }, _G.packer_plugins)]]
