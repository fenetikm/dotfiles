...
vim.cmd [[au FileType php ++once lua require("packer.load")({'vim-php', 'vim-php-manual', 'vim-php-namespace', 'vim-textobj-function', 'phpfolding.vim', 'splitjoin.vim', 'PHP-Indenting-for-VIm'}, { ft = "php" }, _G.packer_plugins)]]
