...
vim.cmd [[au FileType php ++once lua require("packer.load")({'vim-php-namespace', 'PHP-Indenting-for-VIm', 'phpfolding.vim', 'splitjoin.vim', 'vim-textobj-function', 'vim-php', 'vim-php-manual'}, { ft = "php" }, _G.packer_plugins)]]
