...
vim.cmd [[au FileType php ++once lua require("packer.load")({'vim-php', 'vim-php-manual', 'vim-php-namespace', 'vim-textobj-function', 'PHP-Indenting-for-VIm', 'phpfolding.vim', 'splitjoin.vim'}, { ft = "php" }, _G.packer_plugins)]]
