...
_G.packer_plugins = {
  ...
  ["dashboard-nvim"] = {
    ...
    loaded = true,
    path = "/Users/mjw/.local/share/nvim/site/pack/packer/start/dashboard-nvim",
...
vim.cmd [[au FileType php ++once lua require("packer.load")({'phpfolding.vim', 'splitjoin.vim', 'vim-php-manual'}, { ft = "php" }, _G.packer_plugins)]]
