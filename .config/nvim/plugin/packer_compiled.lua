...
vim.cmd [[au FileType php ++once lua require("packer.load")({'PHP-Indenting-for-VIm', 'vim-php', 'vim-php-manual', 'splitjoin.vim', 'phpfolding.vim', 'vim-php-namespace', 'vim-textobj-function'}, { ft = "php" }, _G.packer_plugins)]]
